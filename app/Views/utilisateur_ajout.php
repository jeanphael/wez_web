  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i>  Nouveau </h4>
            <div class="form-panel">
              <div class="form">
                 <?php $validation =  \Config\Services::validation(); ?>
              <?= $validation->listErrors() ?>
                <form class="cmxform form-horizontal style-form" id="signupForm" method="POST" action="<?php echo base_url('user_save');  ?>" enctype="multipart/form-data">
