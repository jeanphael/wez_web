...
<body style="font:18px 'Gilroy', sans-serif !important;background-color:rgb(251,251,251) !important">
  ...
  <!-- Fixed navbar -->
  <nav class="navbar navbar-default navbar-fixed-top" id="menuBar" style="display:none">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">
					<img src="<?php echo base_url('assets/img/logohomeMenu.png'); ?>" />
				</a>
      </div>

      <div class="navbar-collapse collapse">
        <ul class="nav navbar-nav navbar-right ">
          <li class="title1 ins" <?php $session = \Config\Services::session(); if($session->get('userSession') != null){ echo "style='display:none'"; } else echo "style='display:block;'"; ?>>
						<a href="<?php echo base_url('inscription'); ?>" style="" class="amenu smoothscroll">Inscription</a>
					</li>

					<li class="title1 conne" <?php $session = \Config\Services::session(); if($session->get('userSession') != null){ echo "style='display:none'"; } else echo "style='display:block;'"; ?>>
						<a href="<?php echo base_url('connexion'); ?>" class="amenu smoothscroll">Connexion</a>
					</li>

					<li class="title1 mese" <?php $session = \Config\Services::session(); if($session->get('userSession') != null){ echo "style='display:block'"; } else echo "style='display:none;'"; ?>>
