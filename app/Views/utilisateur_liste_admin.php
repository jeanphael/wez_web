...
<body>
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Compte Administrateur</h3>
        <!-- row -->
        <div class="row mt">
          <div class="col-md-12">
			...
			<?php if (! empty($users) && is_array($users)) : ?> 
              <table class="table table-striped table-advance table-hover">
                <h4><i class="fa fa-angle-right"></i> Liste des administrateurs   	|	 <a href="<? echo base_url('user_new');?>"> Ajout nouveau</a></h4>
                <hr>
                <thead>
                  <tr>
				...
				<?php else : ?> 
					<h4>Aucun administrateur enregistr&eacute;</h4> 
				<?php endif ?> 
  ...
  <script type="text/javascript">
    function deleteUser(idUser){
        ...
        if(res){
           url =  "user_delete_admin?id="+idUser;
