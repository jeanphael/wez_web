        ...
        <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6 xs12">
		 <p><?php echo $message; ?></p>
			...
			L&agrave; o&ugrave; les bons plans se trouvent et se cr&eacute;ent</h1>
			 ...
			 <div class="row">
				  <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" id="appHome" style="display:none;background-color:rgb(44,141,130);color:white !important;margin:2%;padding:1%;border-radius:10%">
					 <div class="row">
				  ...
				  <div class="col-lg-4 col-md-5 col-sm-5 col-xs-5" id="googleHome" style="display:none;background-color:rgb(44,141,130);color:white !important;margin:2%;padding:1%;border-radius:10%">
					<div class="row">
