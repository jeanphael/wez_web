...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="<?php echo base_url('validation_reinit_pwd'); ?>" method="POST">
        <h2 class="form-login-heading">Reinitialisation mot de passe</h2>
        <div class="login-wrap">
          <input type="text" class="form-control" placeholder="Nom de l'organisateur" autofocus name="login">
          <br>
